...
const AboutContent = () => {
  ...
  return (
    <div className="about-sec"> 
        <h1>Who Am I?</h1>
        <p>As a second-year student at Maharaja Agrasen Institute of Technology, I have discovered a strong passion for Web development. With a focus on designing and coding, I have developed a range of skills and experience in this field. As a dedicated front-end developer from India, I am committed to creating engaging and visually appealing websites for clients. I am skilled in tech like <u>Html</u>, <u>Css</u>, <u>javascript</u>, <u>React js</u>, <u>Tailwind</u>, <u>Bootstrap</u>, and <u>Firebase</u>, currently aspiring to learn machine learning and backend technologies.
